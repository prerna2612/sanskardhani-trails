...
function showWinningPopup() {
    ...
    document.querySelector('.popup-para').innerText = 'Congratulations on completing the Sanskardhani Trails puzzle. We hope you enjoyed and had a great time playing. Your Score will be converted to coins.';
